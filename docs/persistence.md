...
Schema 5/curriculum 5.0.0 accepts schema 2/curriculum 2.0.0, schema 3/curriculum 3.0.0, and schema 4/curriculum 4.0.0. All preserve bounded evidence, attempts, variants, and current/completed session identity, queue, index, unit, seed, and timestamps; schema 2 maps sessions to Unit 1 and schema 3 gains no placement by default. Schema 4 preserves valid placement results and its evidence-applied flag, but a completed legacy placement is conservatively recommended to Unit 3 because Units 3 and 4 were not assessed.
